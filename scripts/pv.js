...
function updateBarChart(data, year, pv, type, sex, colorLeft, colorRight, selector) {
    const sexLabel = sex === 1 ? "ชาย" : sex === 2 ? "หญิง" : "รวมเพศ";
    const filteredData = data.filter(d => d.year == year && d.age_type == type && d.sex == sex && d.th_province == pv); 
...
function updateHBarChartPV(data, year, pv, type, sex, colorLE, colorHALE, selector) {
    ...
    const filteredData = data.filter(d => d.year == year && d.th_province == pv && d.age_type == type && d.sex == sex); 
...
function updateHBarChartPVCP(data, year, pv, type, sex, colorLE, colorHALE, selector) {
    ...
    const filteredData = data.filter(d => d.year == year && pv.includes(d.th_province) && d.age_type == type && d.sex == sex); 
...
updateBarChart(pvData, filters.year, filters.intPV, 0, 1, m_cl_dark, m_cl_light, "pv-1-male-at-birth");
updateBarChart(pvData, filters.year, filters.intPV, 60, 1, m_cl_dark, m_cl_light, "pv-1-male-at-60");
updateBarChart(pvData, filters.year, filters.intPV, 0, 2, fm_cl_dark, fm_cl_light, "pv-1-female-at-birth");
updateBarChart(pvData, filters.year, filters.intPV, 60, 2, fm_cl_dark, fm_cl_light, "pv-1-female-at-60");
updateBarChart(pvData, filters.year, filters.intPV, 0, 3, b_cl_dark, b_cl_light, "pv-1-bothsex-at-birth");
updateBarChart(pvData, filters.year, filters.intPV, 60, 3, b_cl_dark, b_cl_light, "pv-1-bothsex-at-60");
updateCardValue(pvData, filters.year, filters.intPV, 0, 1, 'LE', m_cl_dark, "pv-1-male-at-birth-le");
updateCardValue(pvData, filters.year, filters.intPV, 0, 1, 'HALE', m_cl_light, "pv-1-male-at-birth-hale");
updateCardValue(pvData, filters.year, filters.intPV, 60, 1, 'LE', m_cl_dark, "pv-1-male-at-60-le");
updateCardValue(pvData, filters.year, filters.intPV, 60, 1, 'HALE', m_cl_light, "pv-1-male-at-60-hale");
updateCardValue(pvData, filters.year, filters.intPV, 0, 2, 'LE', fm_cl_dark, "pv-1-female-at-birth-le");
updateCardValue(pvData, filters.year, filters.intPV, 0, 2, 'HALE', fm_cl_light, "pv-1-female-at-birth-hale");
updateCardValue(pvData, filters.year, filters.intPV, 60, 2, 'LE', fm_cl_dark, "pv-1-female-at-60-le");
updateCardValue(pvData, filters.year, filters.intPV, 60, 2, 'HALE', fm_cl_light, "pv-1-female-at-60-hale");
updateCardValue(pvData, filters.year, filters.intPV, 0, 3, 'LE', b_cl_dark, "pv-1-bothsex-at-birth-le");
updateCardValue(pvData, filters.year, filters.intPV, 0, 3, 'HALE', b_cl_light, "pv-1-bothsex-at-birth-hale");
updateCardValue(pvData, filters.year, filters.intPV, 60, 3, 'LE', b_cl_dark, "pv-1-bothsex-at-60-le");
updateCardValue(pvData, filters.year, filters.intPV, 60, 3, 'HALE', b_cl_light, "pv-1-bothsex-at-60-hale");
updateHBarChartPV(pvData, filters.year, filters.intPV, filters.ageType, 1, m_cl_dark, m_cl_light, 'pv-1-male-pv');
updateHBarChartPV(pvData, filters.year, filters.intPV, filters.ageType, 2, fm_cl_dark, fm_cl_light, 'pv-1-female-pv');
updateHBarChartPV(pvData, filters.year, filters.intPV, filters.ageType, 3, b_cl_dark, b_cl_light, 'pv-1-bothsex-pv');
updateHBarChartPVCP(pvData, filters.year, filters.cpPV, filters.ageType, 1, m_cl_dark, m_cl_light, 'pv-cp-male-pv');
updateHBarChartPVCP(pvData, filters.year, filters.cpPV, filters.ageType, 2, fm_cl_dark, fm_cl_light, 'pv-cp-female-pv');
updateHBarChartPVCP(pvData, filters.year, filters.cpPV, filters.ageType, 3, b_cl_dark, b_cl_light, 'pv-cp-bothsex-pv');
...
document.getElementById('download-csv').addEventListener('click', function(e) {
    ...
    const filteredData = pvData.filter(d => d.year == filters.year && d.age_type == filters.ageType && allPV.includes(d.th_province));
    const filteredData2 = filteredData.map(x => ({ year: x.year, area_code: x.area_code, type: x.age_type, sex: x.sex, 
